...
enum
{
    ...
    IDS_NINJA_ALREAY_IN_FILES,          // "The file %s is alreay in .srcfiles\n"
    ...
    IDS_NINJA_SRCFILES_CREATED,         // ".srcfiles created using %s as the template"
    IDS_NINJA_SRCFILES_EXISTS,          // ".srcfiles already exists in this directory. Are you sure you want to replace it?"
    IDS_NINJA_TAB_CLANG,                // "CLang"
    IDS_NINJA_TAB_COMPILER,             // "Compiler"
    IDS_NINJA_TAB_GENERAL,              // "General"
    IDS_NINJA_TAB_LINKER,               // "Linker"
    IDS_NINJA_TAB_PRIVATE,              // "Private"
