...
// This will create one build?.ninja for each build target (debug32, debug64, release32, release64). Each build file
// will be placed in a build directory with a compiler prefix (build/clangBuild.ninja or build/msvcBuild.ninja). The
// build directory will also hold the dependency files that ninja creates.
