...
/*
    ...
    was created. It will differ based on the platform, the compiler available to it, and it will assume MakeNinja.exe is available
    since that was what was used to create it.
...
bool CNinja::VsCodeMakefile()
{
    ...
    if (FindFileEnv("PATH", "mingw32-make.exe", cszPath))
        bMakeExe = true;
