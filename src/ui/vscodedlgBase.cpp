...
VsCodeDlgBase::VsCodeDlgBase(wxWindow* parent, wxWindowID id, const wxString& title,
	...
	wxDialog(parent, id, title, pos, size, style)
{
    ...
    static_box = new wxStaticBoxSizer(wxVERTICAL, this, wxString::FromUTF8("tasks.json"));
    ...
    static_box_sizer2 = new wxStaticBoxSizer(wxVERTICAL, this, wxString::FromUTF8("Default task"));
    ...
    static_box_sizer3 = new wxStaticBoxSizer(wxVERTICAL, this, wxString::FromUTF8("launch.json Pre-launch build"));
